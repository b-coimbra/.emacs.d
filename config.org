...
* Table of contents :toc:
  ...
  - [[*Font][Font]]
	- [[*Ligatures][Ligatures]]
  - [[*Themes][Themes]]
    - [[*\[\[https://github.com/ogdenwebb/emacs-kaolin-themes\]\[Kaolin themes\]\]][Kaolin themes]]
    - [[*\[\[https://github.com/hlissner/emacs-doom-themes\]\[Doom themes\]\]][Doom themes]]
  - [[*Appearance][Appearance]]
    - [[*\[\[https://github.com/domtronn/all-the-icons.el\]\[All the icons\]\]][All the icons]]
    - [[*\[\[https://github.com/hlissner/emacs-solaire-mode\]\[Solaire mode\]\]][Solaire mode]]
  - [[*Modeline][Modeline]]
    - [[*\[\[https://github.com/TheBB/spaceline\]\[Spaceline\]\]][Spaceline]]
    - [[*\[\[https://github.com/seagle0128/doom-modeline\]\[Doom-modeline\]\]][Doom-modeline]]
  - [[*Dashboard][Dashboard]]
    - [[*\[\[https://github.com/emacs-dashboard/emacs-dashboard\]\[emacs-dashboard\]\]][emacs-dashboard]]
  - [[*Auto Completion][Auto Completion]]
    - [[*\[\[https://github.com/company-mode/company-mode\]\[Company\]\]][Company]]
  - [[*Evil][Evil]]
  - [[*Org-mode][Org-mode]]
...
** Globals
   ...
   #+begin_src emacs-lisp
     (setq
      globals--banner-path  "var/banners/blackhole.png"     ; Banner image path shown in the dashboard
      globals--font         "Iosevka 12"                    ; Font family and font size
      globals--theme        'doom-sourcerer                 ; Theme used by Emacs.
      )
   #+end_src
