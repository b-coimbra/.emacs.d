...
#+subtitle: Doom-like emacs config with a teensy tiny fragment of weebness.
#+date: <2020-02-01 Sat>
...
* Installation
  ...
  3. Install [[https://github.com/emacs-lsp/lsp-mode#supported-languages][language servers]]
     ...
     (use-package dashboard
       ...
       (dashboard-navigator-buttons
        `(((,(all-the-icons-octicon "octoface" :height 1.1 :v-adjust 0.0)
            "Homepage"
            "Browse homepage"
            (lambda (&rest _) (browse-url "https://github.com/b-coimbra/.emacs.d")))
