...
#+subtitle: Doom-like emacs config with a teensy tiny piece of weebness.
#+date: <2020-02-01 Sat>
...
* Introduction
  ...
  *[M E G U M A C S]*
  ...
  [[https://github.com/b-coimbra/.emacs.d][*Github*]] | [[https://emacs.metaphoric.dev/config.org][*Source*]]
  #+end_center
...
* Installation
  ...
  4. Install [[https://github.com/emacs-lsp/lsp-mode#supported-languages][language servers]] manually or with =M-x lsp-install-server=
...
** [[https://github.com/emacsmirror/org-contrib][org-contrib]]
