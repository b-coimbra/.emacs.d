...
** Globals
   ...
   #+begin_src emacs-lisp
	 (setq
	  globals--banner-path "banners/blackhole.png" ; Banner image path shown in the dashboard
...
** org
   ...
   #+begin_src emacs-lisp
     (use-package org
       ...
       :config
       ;; org-agenda
       (setq org-agenda-files '("~/dev/scribbles/org/schedule/schedule.org"))
       ;; org-todo
