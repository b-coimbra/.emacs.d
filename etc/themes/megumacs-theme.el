;;; megumacs-theme.el --- Theme

;; Copyright (C) 2021 , b-coimbra
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'megumacs
        ...
        `(mode-line ((t (:background "#51434a" :foreground "#d5c4a1" :box nil))))
        `(mode-line-inactive ((,class (:background "#3f363b" :foreground "#a89984" :box nil))))
        `(vertical-border ((,class (:background "#3f363b" :foreground "#3f363b" :box nil))))
	...
	`(org-code ((,class (:foreground ,func))))
	...
	`(slime-repl-inputed-output-face ((,class (:foreground ,type))))
        `(trailing-whitespace ((,class :foreground nil :background nil)))
...
(provide-theme 'megumacs)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; megumacs-theme.el ends here
